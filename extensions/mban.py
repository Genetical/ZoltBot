## README
## Ok, so this code is trashy and unoptimised, need to create a utils modules which handles front-end ui's for the menu instead of this trash, or even better, a util which holds all the menu templates.
##
